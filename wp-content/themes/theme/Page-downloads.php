                                ...
                                <div class="col-lg-10 offset-lg-1">
                                    <div class="caption">
                                        ...
                                        <div class="custom-font">
                                            <h5 class="thin custom-font">Keep a copy for ready reference</h5>
            ...
            <div class="row">
                ...
                <div class="img">
                                <a href="blog-details.html">
                                    <img src="<?php bloginfo('template_directory'); ?>/img/clients/download1.jpg" alt="" class="thumparallax">
                                </a>
                                
                            </div>
                    
                    <h6 class="mb-20">Product Brochure</h6>
                    <p>Download the Nuvocotto premium product brochure.</p>
                    <br>
                    <a href="#0" class="more custom-font mt-30">Download</a>
                </div>

                <div class="col-lg-3 col-md-6 item-bx">
                <div class="img">
                                <a href="blog-details.html">
                                    <img src="<?php bloginfo('template_directory'); ?>/img/clients/download2.jpg" alt="" class="thumparallax">
                                </a>
                                
                            </div>
                    
                    <h6 class="mb-20">Nuvocotto Jaalis</h6>
                    <p>Choose the suitable Nuvocotto Jaalis patterns from here.</p>
                    <a href="#0" class="more custom-font mt-30">Download</a>
                </div>
                ...
                <div class="img">
                                <a href="blog-details.html">
                                    <img src="<?php bloginfo('template_directory'); ?>/img/clients/download3.jpg" alt="" class="thumparallax">
                                </a>
                                
                            </div>
                    
                    <h6 class="mb-20">Drawings</h6>
                    <p>Download jaali models & use it for your design</p>
                    <br>
                    <a href="#0" class="more custom-font mt-30">Download</a>
                </div>
