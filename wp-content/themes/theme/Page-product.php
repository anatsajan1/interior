                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="opportunity">Franchise Opportunity</a>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Inspirations</a>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="idea">Ideas & References</a>
                            <a class="dropdown-item" href="featured">Featured Projects</a>
            ...
            <div class="swiper-wrapper cta__slider">
                ...
                <div class="cta__slider-item swiper-slide">
                    <div class="media-wrapper slide-inner valign">
                        <div class="bg-img" data-background="<?php bloginfo('template_directory'); ?>/img/slid/01.jpg" data-overlay-dark="5"></div>
                        <div class="container">
                            <div class="row">
        ...
        <div class="container">
            ...
            <div class="section-head text-center">
                <div class="row justify-content-center">
                    <div class="col-lg-6 col-md-8 col-sm-10">
                        ...
                        <h4 class="playfont wow flipInX" data-wow-delay=".5s"></h4>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                    ...
                    <div class="item wow fadeInUp md-mb50" data-wow-delay=".3s">
                        <div class="post-img">
                            <div class="img">
                                <img src="<?php echo $image['url'];?>" style="width: 600px;px;height: 300px;px;alt="">
                                <div class="mb-10">
                                <a href="<?php echo (get_permalink($id)); ?>" class="btn-curve btn-color mt-30">
                                 <h6><?php echo $name; ?></h6>
                    ...
                    <h6 class="custom-font wow fadeInDown" data-wow-delay=".3s">Most common questions</h6>
                        <h4 class="playfont wow flipInX" data-wow-delay=".5s">Most popular topics</h4>
                        <div class="item">
                            <div class="comment-img">

                            </div>
                            <div class="info">
                                <h6>What is the life of Mangalore Roof Tiles?</h6>
                                <br>
                                <p>The properly installed roof tiles can last over fifty years unless any external forces break it. Multiple external factors like rain or wind may misplace the roofing tiles, but it can be easily maintained.</p>
                            </div>
                            <div class="info">
                                <h6>Will the Roofing Tile Fly away in Wind?</h6>
                                <br>
                                <p>The weight of a Standard Mangalore Roof Tile is around 3.00 Kg, and there is tile to tile interlocking. Clay Roofing Tile will not fly unless the wind is extreme. If the Roofing Tiles are over a multi-story building, it is recommended special protection like tieing tiles with a metal wire to batons.</p>
                            </div>
                        </div>
            ...
            <div class="dots-half bg-img bg-repeat" data-background="<?php bloginfo('template_directory'); ?>/img/dots.png"></div>
    </section>
