...
<body>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <a class="dropdown-item" href="about-us">About</a>
                            ...
                            <a class="dropdown-item" href="award">Nuvocotto Award</a>
            ...
            <div class="swiper-wrapper cta__slider">
                ...
                <div class="cta__slider-item swiper-slide">
                    <div class="media-wrapper slide-inner valign">
                        <div class="bg-img" data-background="<?= get_the_post_thumbnail_url($id) ?>" data-overlay-dark="5"></div>
                        <div class="container">
                            <div class="row">
        ...
        <div class="container">
            <div class="section-head text-center mb-0">
                <div class="row justify-content-center">
                    ...
                    <br>
                        <h6 class="playfont"><?php echo get_post_meta($post->ID, 'product-description', true);?></h6>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="blog-grid center bg-gray section-padding">
        <div class="container">
            ...
            <div class="row">
                <?php
                if (have_rows('sub-category')){

                    // Loop through rows.
                     while (have_rows('sub-category')) : the_row();
                        $sub_image = get_sub_field('image');
                        $sub_name = get_sub_field('sub-name');
                        $sub_required = get_sub_field('required');
                        $sub_weight = get_sub_field('weight');
                        $sub_size = get_sub_field('size');
                        $sub_thickness = get_sub_field('thickness');
                ...
                ?>
                        ...
                        <div class="col-md-6">
                            <div class="item wow fadeInUp md-mb50" data-wow-delay=".3s">
                                <div class="post-img">
                                    <div class="img">
                                        <img src="<?php echo $sub_image['url']; ?>" alt="" style="width:260px;height:340px;">                                      <div class="mb-10">
                                            <div class="sp-text">
                                                <h3><?php echo $sub_name; ?></h3>
                                                <p><?php echo $sub_required; ?></p>
                                                <p><?php echo $sub_weight; ?></p>
                                                <p><?php echo $sub_size; ?></p>
                                                <p><?php echo $sub_thickness; ?></p>
                                                
                                                <button type="submit" class="btn btn-primary sub-btn"> REQUEST A QUOTE </button>
                                            </div>
